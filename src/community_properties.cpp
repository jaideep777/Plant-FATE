...
void EmergentProps::update(double t, Solver &S){
	...
	gs = (trans*55.55/365/86400)/1.6/(static_cast<PSPM_Dynamic_Environment*>(S.env)->weightedAveClim.vpd/1.0325e5);
	// gs = integrate_prop(t, S, [](const PSPM_Plant* p){return p->res.gs_avg;});
