...
/// @param t      Time in current timestep.
/// @param sol    Pointer to the Solver being used, provided for computing state integrals. The Solver provides this via a `this` reference. 
