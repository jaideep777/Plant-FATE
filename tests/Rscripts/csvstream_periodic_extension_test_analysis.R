dat = read.delim("~/codes/Flare_v2/csvstream_met.txt", header=F)
colnames(dat) = c("julian", "t", "Year", "Month", "Year.dec", "Temp", "VPD", "PAR", "ppfd_max", "SWP")
dato = read.csv("~/codes/Flare_v2/tests/data/MetData_AmzFACE_Monthly_2000_2015_PlantFATE.csv", header=T)
