...
matplot(x=dat1$t, y=dat1[,-1], type="l", lty=1, col=rainbow(length(which(traits1$resident==1))), lwd=1+2*traits1$resident, ylim=c(0, 1))
abline(h=traits1$K[traits1$resident==1], col=scales::muted(rainbow(nrow(traits1))))
